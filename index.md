...
void loseDisplay()
{
  ...
  digitalWrite(ledPinred2, HIGH);   // turn the LED on (HIGH is the voltage level)
  delay(1000);                       // wait for a second
  digitalWrite(ledPinred2, LOW);    // turn the LED off by making the voltage LOW
  delay(1000);
}
...
<HTML>
 ...
 <img src="https://hackster.imgix.net/uploads/attachments/298935/simon_says_fritzing_2_bb_hytMesQ4as.png?auto=compress%2Cformat&w=740&h=555&fit=max"> 
